...
# Alle 18 begreber
for b in [
    "01-dynamisk-stilhed", "02-breath-of-life", "03-primary-respiration", "04-midtlinjen",
    "05-the-health", "06-motion-present", "07-fulcrum", "08-stillpoints", "09-transmutation",
    "10-the-neutral", "11-automatic-shifting", "12-den-iboende-behandlingsplan",
    "13-fluid-body", "14-the-lesion-field", "15-potency", "16-ignition",
    "17-axial-fluctuations", "18-wholeness"
]:
    TYPE[b] = "begreb"
...
# Skriv JSON
with open("relationer.json", "w", encoding="utf-8") as f:
    json.dump(relationer, f, ensure_ascii=False, indent=2)

print()
print(f"✅ Skrevet til relationer.json")
